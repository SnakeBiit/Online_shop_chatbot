    ...
    if(isset($_GET['username']) && isset($_GET['pass'])){
     ...
     $username = mysqli_real_escape_string($connection, $username);
      ...
      while($row = mysqli_fetch_array($select_user_query)){
         ...
         $db_user_budget = $row['budget'];
      }
      $pass = crypt($pass, $db_user_pass);
      if($username === $db_user_name && $pass === $db_user_pass ){
        $_SESSION['username'] = $db_user_name;
        $_SESSION['user_firstname'] = $db_user_firstname;
        $_SESSION['user_lastname'] = $db_user_lastname;
        $_SESSION['user_role'] = $db_user_role;
        $_SESSION['budget'] =  $db_user_budget;
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
          <form  class="login100-form validate-form" methon = "post">
            ...
            <div class="text-right p-t-8 p-b-31">
              <a href="../ForgotPassword/forgot.php">
                Forgot password?
              </a>
            </div>
